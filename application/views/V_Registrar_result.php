        ...
        <tbody class="divide-y divide-gray-100">
            <?php foreach ($results as $result): ?>
              ...
              <td class="p-3 text-sm whitespace-nowrap class bg-blue-200 text-center"><?= $result['student_number'] ?></td>
                ...
                <a href="/C_Registrar_checklist/studentGrade/?student_id"><span class="p-1.5 text-xs font-medium uppercase tracking wider text-blue-800 rounded-lg hover:font-bold"><pre>     VIEW</pre></span></a>
                </td>
