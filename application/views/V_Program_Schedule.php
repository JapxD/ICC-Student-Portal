...
<main class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 mb-20 mt-12">
  <input class="text-center" type="text" name="" value="<?= $schedule_info['teacher_name'] ?>" disabled>
<input class="pl-4 pr-4" type="text" name="" value="<?= $schedule_info['subject_name'] ?>" disabled>
